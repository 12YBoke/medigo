...
export const HowItWorks = () => {
  ...
  return (
    <Container
      ...
      className="relative scroll-mt-24 bg-primary-50"
    >
      <Container className="py-20 md:py-40 lg:py-52 flex flex-col gap-12 md:gap-16 items-center ">
        ...
        <Container className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-4 lg:px-16 2xl:px-24 gap-1">
          {HowItWorksContent.map(({ id, title, description, Icon }, index) => (
            <Container
              key={id}
              className={clsx(
            ...
            >
              ...
              {Icon && (
                <Container
                  className={clsx(
                    "flex items-center justify-center w-20 h-20 rounded-full animate",
